  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <p
            className="font-garamond uppercase mb-4"
          ...
          />
          <p
            className="font-garamond text-cream/55 max-w-xl mx-auto"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {SERVICES.map((svc, i) => (
            ...
            >
              <Link
                href={svc.href}
                className="group block h-full rounded-[4px] p-8 text-center relative overflow-hidden transition-all duration-400"
                style={{
              ...
              >
                {/* Hover glow overlay */}
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-[4px]"
                  style={{ boxShadow: `inset 0 0 80px ${svc.glow}` }}
                />

                {/* Symbol */}
                <div
                  className="text-[58px] leading-none mb-5 transition-transform duration-300 group-hover:-translate-y-1"
                  style={{
                    color: svc.color,
                    filter: `drop-shadow(0 0 20px ${svc.glow})`,
                  }}
                >
                  {svc.symbol}
                </div>
                ...
                {/* Title */}
                <h3
                  className="font-cinzel font-bold text-white mb-2"
                ...
                <div
                  ...
                  style={{ fontSize: '22px', color: svc.color }}
                >
                  {svc.price}
                </div>
                <div
                  className="font-garamond mt-1"
                  style={{ fontSize: '11px', color: 'rgba(245,236,215,0.3)', letterSpacing: '2px', textTransform: 'uppercase' }}
                >
                  per session
                </div>
                ...
                {/* Arrow */}
                <div
                  className="mt-5 font-cinzel uppercase opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-y-0 translate-y-2"
